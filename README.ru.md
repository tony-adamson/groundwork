...
Пайплайн — три навыка, каждый производит один ревьюируемый Markdown-артефакт:
...
> Инструкции навыков написаны на русском. Имена файлов, статусы, команды и все
> машиночитаемые части — на английском.
...
В Claude Code: `/codebase-analysis`, `/solution-design`, `/planf3`.
В Codex CLI: `$codebase-analysis`, `$solution-design`, `$planf3`.
...
закрыты на явный вызов и отказываются от случайного использования.
