---
name: scope-review
description: "Ревью обоснованности diff перед PR: каждое добавление вызвано текущим требованием, код мимикрирует под локальные паттерны, нет прослоек и дублирования, diff гигиеничен. Только находки, без правок. Запускать только по явной просьбе пользователя."
argument-hint: "[git ref/range или путь; пусто = diff рабочего дерева против merge-base]"
